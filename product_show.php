    ...
    ?>
        <div id="content_right">
                <?php
                 ...
                 $query_cat = mysqli_query($link, $sql_cat)or die(mysqli_error());
                 $result = mysqli_fetch_array($query_cat);
                 
                ?>
                
                <div id="top_content_right" >
                    <span>
                      <a href="index.php">หมวดหมู่สินค้า ></a> 
                      <a href="product_all.php">สินค้าทั้งหมด ></a>
                      <a href="#album_product"><?php echo $result['cat_name']; ?></a>
                    </span>
              ...
              <hr color="#f2f2f2"><br>
                        ...
                        <!-- id="album_product div โชร์สินค้าทั้งหมด จากตาราง product-->    
                        <div id="album_product">
                        <!--select เพื่อโชร์สินค้าทั้งหมด จากตาราง product-->
                          ...
                          <p style=" font-size:25px; text-align: left; padding-left: 28px; "><?php echo $result['cat_name']; ?></p>
                          <br>
                            <?php 
                            $i = 0;
