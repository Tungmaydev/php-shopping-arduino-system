    ...
    <body>
        ...
        ?>
                <div id="content_center"><br><br><br>
                 <p style="text-align: center; color: #FE9221;font-weight: bold;font-size: 20px;">Add Main Category</p>
                    <form>
                        <table style="font-size: medium; margin: auto; width: 90%;"  border="1" cellpadding="2" cellspacing="0">  
                            <tr>
                              ...
                              <td><input style="height: 39px; width: 99%; font-size: 18px;" type="text" name="main_name" size="100" maxlength="100" required ></td>
                           </tr>
                        </table><br><br>
                        ...
                        <div style="text-align: center;">
                            ...
                            <button style="border-radius:8px; padding: 9px 11px;  width: 20%; background-color:#93c3cd;  color: #004d4d; font-size: 15px; font-weight: bold;"  height="50px;" type="submit" name="submit" formaction="main_add.php" formmethod="post"/>Add Main Category</button>                        
                        </div>
                        <br>
                    </form>
                </div>      
